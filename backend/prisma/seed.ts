...
async function main() {
  ...
  const permissions = await prisma.permission.createMany({
    data: [
      ...
      { name: "Sale-View", moduleId: 17 },
      { name: "Sale-Create", moduleId: 17 },
      { name: "Sale-Edit", moduleId: 17 },
      { name: "Sale-Delete", moduleId: 17 },
      { name: "Sale-Print", moduleId: 17 },
      { name: "Sale-Approve", moduleId: 17 },
      { name: "Sale-Payment", moduleId: 17 },
      { name: "Sale-Return", moduleId: 17 },
      { name: "Declare-VAT", moduleId: 17 },
      ...
      { name: "Stock-Transfer-View", moduleId: 20 },
      { name: "Stock-Transfer-Create", moduleId: 20 },
      { name: "Stock-Transfer-Edit", moduleId: 20 },
      { name: "Stock-Transfer-Delete", moduleId: 20 },
      { name: "Stock-Transfer-Approve", moduleId: 20 },
      ...
      { name: "Purchase-Return-View", moduleId: 22 },
      { name: "Purchase-Return-Create", moduleId: 22 },
      { name: "Purchase-Return-Edit", moduleId: 22 },
      { name: "Purchase-Return-Delete", moduleId: 22 },
      { name: "Purchase-Return-Approve", moduleId: 22 },
      ...
      { name: "Sale-Report", moduleId: 25 },
      { name: "Cancel-Sale", moduleId: 25 },
      { name: "Payment-Sale-Report", moduleId: 25 },
      ...
      { name: "Return-Purchase-Report", moduleId: 25 },
      { name: "Sale-Return-Report", moduleId: 25 },
